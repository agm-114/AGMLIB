...
public class Craft : DumbfireRocket, ICraft
{
    ...
    public override System.Guid SavedNetworkSpawnKey => new(GUID);
    ...
    protected override bool FuzeActive(){ return false; }
    protected override bool GenericImpact(MunitionHitInfo hitInfo, bool trigger) { return false; }
    protected override bool DamageableImpact(IDamageable hitObject, MunitionHitInfo hitInfo, bool trigger) { return false; }
}
