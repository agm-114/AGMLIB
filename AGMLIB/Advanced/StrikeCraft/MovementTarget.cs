public class MovementTarget : MonoBehaviour
{
    ...
    public bool Valid(ICraft craft, string filter) => _filter == filter && Craft == null && craft != null
        && (craft is not LookaheadMunition missile || FormationManager.ShipController.GetIFF(missile.OwnedBy) == Game.IFF.Mine);
